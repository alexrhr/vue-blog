...
<template>
  <v-container>
    ...
    <v-row>
      <v-col cols="12">
        <v-card>
          <v-card-title class="headline">Willkommen bei [App-Name] – deinem persönlichen Finanzmanager!</v-card-title>
          <v-card-text>
          ...
          <v-card-text>
            <p>Starte noch heute und erlebe, wie einfach Finanzmanagement sein kann. [App-Name] – Dein verlässlicher Partner für finanzielle Freiheit!</p>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
